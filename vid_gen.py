...
def main():
    ...
    parser = argparse.ArgumentParser(description='Generate AI commentary for gameplay videos')
    parser.add_argument('input_video', type=str, help='Path to input video file')
    parser.add_argument('output_video', type=str, help='Path to output video file')
    parser.add_argument('--filtered-dir', type=str, default='filtered_output',
                       help='Directory for filtered outputs (default: filtered_output)')
    parser.add_argument('--speech-file', type=str, default='SPEECH.wav',
                       help='Path to speech audio file (default: SPEECH.wav)')
    ...
    try:
        ...
        # Process video with parsed arguments
        generator.add_commentary(
            args.input_video,
            args.output_video,
            args.filtered_dir,
            args.speech_file
